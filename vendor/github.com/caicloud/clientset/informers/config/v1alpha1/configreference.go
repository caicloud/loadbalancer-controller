...
func (f *configReferenceInformer) defaultInformer(client client_go_kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *configReferenceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&config_v1alpha1.ConfigReference{}, f.defaultInformer)
}
