...
func (f *tagInformer) defaultInformer(client client_go_kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *tagInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resource_v1beta1.Tag{}, f.defaultInformer)
}
