...
func (f *loadBalancerInformer) defaultInformer(client client_go_kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *loadBalancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&loadbalance_v1alpha2.LoadBalancer{}, f.defaultInformer)
}
