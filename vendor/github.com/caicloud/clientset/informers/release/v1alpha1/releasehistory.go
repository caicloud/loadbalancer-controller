...
func (f *releaseHistoryInformer) defaultInformer(client client_go_kubernetes.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *releaseHistoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&release_v1alpha1.ReleaseHistory{}, f.defaultInformer)
}
