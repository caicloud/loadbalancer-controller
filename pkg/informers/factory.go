...
import (
	...
	"github.com/caicloud/loadbalancer-controller/pkg/informers/caicloud"
...
func (f *sharedInformerFactory) Caicloud() caicloud.Interface {
	return caicloud.New(f)
}
