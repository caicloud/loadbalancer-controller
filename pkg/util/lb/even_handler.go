...
import (
	...
	netinformers "github.com/caicloud/loadbalancer-controller/pkg/informers/networking/v1alpha1"
...
func NewEventHandlerForDeployment(lbInformer netinformers.LoadBalancerInformer, dInformer extensionsinformers.DeploymentInformer, helper *controllerutil.Helper, filterFunc filterFunc) *EventHandlerForDeployment {
...
func (c *EventHandlerForDeployment) resolveControllerRef(namespace string, controllerRef *metav1.OwnerReference) *netv1alpha1.LoadBalancer {
...
func (c *EventHandlerForDeployment) GetLoadBalancersForDeplyments(d *extensions.Deployment) []*netv1alpha1.LoadBalancer {
