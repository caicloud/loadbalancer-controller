...
import (
	...
	configurationv1 "github.com/caicloud/loadbalancer-controller/pkg/kong/apis/configuration/v1"
	versioned "github.com/caicloud/loadbalancer-controller/pkg/kong/client/clientset/versioned"
	internalinterfaces "github.com/caicloud/loadbalancer-controller/pkg/kong/client/informers/externalversions/internalinterfaces"
	v1 "github.com/caicloud/loadbalancer-controller/pkg/kong/client/listers/configuration/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigurationV1().KongClusterPlugins().List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigurationV1().KongClusterPlugins().Watch(options)
			},
		},
